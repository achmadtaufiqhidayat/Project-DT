...
$sql3   = "SELECT * FROM mata_kuliah WHERE id_matkul = $id_matkul";
$q3     = mysqli_query($koneksi, $sql3);
while ($r3 = mysqli_fetch_array($q3)) {
    $name         = $r3['name'];
    $logika_algoritma        = $r3['logika_algoritma'];
    $matematika_Diskrit       = $r3['matematika_Diskrit'];
    $wk_sistemtertanam     = $r3['wk_sistemtertanam'];
    $wk_pcv   = $r3['wk_pcv'];
    $sistem_cerdas     = $r3['sistem_cerdas'];
    $wk_sistem_cerdas  = $r3['wk_sistem_cerdas'];
    $file_lama     = $r3['file'];
}
?>
<!DOCTYPE html>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group"> <label class="form-label">ID Matkul</label> <input
                                        value="<?=$id_matkul?>"    class="form-control" disabled  name="id_matkul" placeholder="ID Matkul"> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-12 mb-24">
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    ...
                                    <input name="logika_algoritma" value="<?=$logika_algoritma?>" class="form-control" maxlength="2" onkeyup="oneDot(this)" placeholder="Tulis nilai anda"> </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <input name="Matematika_Diskrit" value="<?=$matematika_Diskrit?>" class="form-control" maxlength="2" onkeyup="oneDot(this)" placeholder="Tulis nilai anda"> </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <div class="form-group"> <label class="form-label">Nilai</label> 
                                    <input name="wk_SistemTertanam" value="<?=$wk_sistemtertanam?>" class="form-control" maxlength="2" onkeyup="oneDot(this)" placeholder="Tulis nilai anda"> </div>
                                </div>
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <div class="form-group"> 
                                        <!-- <label class="form-label">Jenis Matakuliah: Mata Kuliah Dasar</label>  -->
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <input name="Wk_pcv" value="<?=$wk_pcv?>" class="form-control" maxlength="2" onkeyup="oneDot(this)" placeholder="Tulis nilai anda"> </div>
                                </div>
                            </div>   
                            <div class="row">
                                <div class="col-md-6 col-sm-12 mb-24">
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <div class="form-group"> <label class="form-label">Nilai</label> 
                                    <input name="sistem_cerdas" value="<?=$sistem_cerdas?>" class="form-control" maxlength="2" onkeyup="oneDot(this)" placeholder="Tulis nilai anda"> </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <input name="wk_sistem_cerdas" value="<?=$wk_sistem_cerdas?>" class="form-control" maxlength="2" onkeyup="oneDot(this)" placeholder="Tulis nilai anda"> </div>
                                </div>
                            </div>   

                                <div class="form-group">
                                    <label>Upload File Skripsi</label>
                                    <input type="text" class="form-control" value="<?=$name?>" name="name"placeholder="Enter your file name" required>
                                    <input class="form-control" type="file" name="file">
                                </div>
                                <div class="submit-section">
                                    <button class="btn btn-primary submit-btn" type="submit" name="ubah">Ubah</button>
                                </div>
                            </form>
                        </div>
                    </div>
